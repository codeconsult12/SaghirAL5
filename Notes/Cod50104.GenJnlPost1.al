codeunit 50104 "Gen. Jnl.-Post1"
{
    ...
    var
        ...
        GenJnlPostBatch: Codeunit "Gen. Jnl.-Post Batch1";
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            MyRecordRef.Open(Database::"FA Ledger Entry");

            //MyRecordRef.Open(Database::"Gen. Journal Batch");
            //MyRecordRef.Open(Database::"Gen. Journal Template");
            ;
            if not (PreviewMode or HideDialog) then begin
                if not Dialog.Confirm(Text001, true) then begin
                    exit;
                end;
            end;
