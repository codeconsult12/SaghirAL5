codeunit 50106 "Gen. Jnl.-Post Line1"
{
                                    ...
                                    begin
                                        ...
                                        then begin
                                            ...
                                            if ExpenseAmount <> 0 then begin
                                                ...
                                                "Source Curr. VAT Base Amount" += AddCurrExpense;
                                                "Source Curr. VAT Amount" := "Source Currency Amount" - "Source Curr. VAT Base Amount";
                                            end;
                                        end;
                                        GLEntry."Additional-Currency Amount" := "Source Curr. VAT Base Amount";
                                        if "Source Currency Code" = AddCurrencyCode then
    ...
    begin
        with GenJnlLine do begin
            ...
            if ((Amount <= 0) and ("Bank Payment Type" = "Bank Payment Type"::"Computer Check") and "Check Printed") or
               ...
               (("Bank Payment Type" = "Bank Payment Type"::"Electronic Payment") and "Check Exported") or
               (("Bank Payment Type" = "Bank Payment Type"::"Electronic Payment-IAT") and "Check Transmitted") or
               (("Bank Payment Type" = "Bank Payment Type"::"Electronic Payment-IAT") and "Check Exported") or
                    ...
                    "Bank Payment Type"::"Electronic Payment", "Bank Payment Type"::"Electronic Payment-IAT":
                        begin
                            if "Bank Payment Type" = "Bank Payment Type"::"Electronic Payment-IAT" then
                                TestField("Check Exported")
                            else
                                if BankAcc."Export Format" = BankAcc."Export Format"::Other then // AMC
    ...
    begin
        ...
        GLEntry.Init();
        GLEntry.CopyFromGenJnlLine1(GenJnlLine);
    ...
    begin
        ...
        repeat
            ...
            OnApplyCustLedgEntryOnBeforeTempOldCustLedgEntryDelete(TempOldCustLedgEntry, NewCVLedgEntryBuf, GenJnlLine);
    ...
    begin
        ...
        if GenJnlLine."Applies-to Doc. No." <> '' then begin
            ...
            OnPrepareTempCustLedgEntryOnAfterSetFiltersByAppliesToId(OldCustLedgEntry, GenJnlLine, NewCVLedgEntryBuf);
    ...
    begin
        ...
        with VATEntry2 do begin
            ...
            "Remaining Unrealized Amount" := "Remaining Unrealized Amount" - NewVATEntry.Amount - VATEntry."Realized Amount";
            "Remaining Unrealized Base" := "Remaining Unrealized Base" - NewVATEntry.Base - VATEntry."Realized Base";
            "Add.-Curr. Rem. Unreal. Amount" :=
              "Add.-Curr. Rem. Unreal. Amount" - NewVATEntry."Additional-Currency Amount" - NewVATEntry."Add.-Curr. Realized Amount";
            "Add.-Curr. Rem. Unreal. Base" :=
              "Add.-Curr. Rem. Unreal. Base" - NewVATEntry."Additional-Currency Base" - NewVATEntry."Add.-Curr. Realized Base";
            "Realized Amount" -= NewVATEntry."Realized Amount";
            "Realized Base" -= NewVATEntry."Realized Base";
            "Add.-Curr. Realized Amount" -= NewVATEntry."Add.-Curr. Realized Amount";
            "Add.-Curr. Realized Base" -= NewVATEntry."Add.-Curr. Realized Base";
            Modify;
        end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCreateGLEntriesForTotalAmounts(var InvoicePostBuffer: Record "Invoice Post. Buffer"; GenJournalLine: Record "Gen. Journal Line"; var GLAccNo: Code[20])
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnApplyCustLedgEntryOnBeforeTempOldCustLedgEntryDelete(var TempOldCustLedgEntry: Record "Cust. Ledger Entry" temporary; var NewCVLedgEntryBuf: Record "CV Ledger Entry Buffer"; var GenJnlLine: Record "Gen. Journal Line")
    begin
    end;
