...
!function (a, b, c, d) {
    ...
    var j = "table2excel", k = {
        exclude: ".noExl", name: "Table2Excel"
    };
    e.prototype = {
        init: function () {
            var b = this;
            b.template = {
                ...
                a(b.element).each(function (c, d) {
                    ...
                    a(d).find("tr").not(b.settings.exclude).each(function (c, d) {
                        ...
                        b.settings.exclude_inputs && (e = i(e)),
                        b.tableRows.push(e)
                }),
        ...
        tableToExcel: function (d, e, g) {
            ...
            if (delete k.ctx.table, !c.documentMode) {
                ...
                b.URL = b.URL || b.webkitURL,
                    i = b.URL.createObjectURL(m),
                    j = c.createElement("a"),
                    j.download = f(k.settings),
                    j.href = i,
                ...
                txtArea1.document.open("text/html", "replace"),
                    ...
                    txtArea1.document.close(), txtArea1.focus(),
